...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.permissions.has("MANAGE_MESAGES")) return message.channel.send("❌ | Bạn không có quyền để sử dụng lệnh này!");
        ...
        .setDescription(`✅ | Successfully changed ${message.channel}'s slowmode to ${args[0]}.`)
        .setColor("GREEN");
